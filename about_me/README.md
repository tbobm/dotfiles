...
* [JenkinsTemplateForApp](https://github.com/debugtalk/JenkinsTemplateForApp) - Jenkins job template with build scripts for packing apps, include iOS and Android. Very ease to use, out-of-box.
...
* [osirinette2_pause](https://github.com/pointu-l/osirinette2_pause) - Osirinette2 is a GUI, cross-plateform Qt version of the Osirinette written in Python.
